...
class notification {
  constructor() {
    PushNotification.createChannel(
      {
        channelId: 'channel-schedule', // (required)
        channelName: 'Movie Play Reminder', // (required)
        channelDescription:
          'a Notification for reminder when your movie booking will play', // (optional) default: undefined.
  ...
  reminderMovieSchedule({title, message, date}) {
    PushNotification.localNotificationSchedule({
      ...
      channelId: 'channel-schedule', // (required) channelId, if the channel doesn't exist, notification will not trigger.
